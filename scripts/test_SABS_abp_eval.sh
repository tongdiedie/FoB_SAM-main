...
TRAIN_LOGDIR=${TRAIN_LOGDIR:-./exps_train_on_SABS_ABP_FULL}
RESULT_LOGDIR=${RESULT_LOGDIR:-./results_SABS_ABP_EVAL}

export USE_MULTIRING_BPPC=${USE_MULTIRING_BPPC:-1}
export USE_LEARNABLE_RING_FUSION=${USE_LEARNABLE_RING_FUSION:-1}
export USE_PROMPT_VALIDITY_FILTER=${USE_PROMPT_VALIDITY_FILTER:-1}
export USE_SAM_SELECTOR=${USE_SAM_SELECTOR:-1}
...
echo "USE_MULTIRING_BPPC=${USE_MULTIRING_BPPC}"
echo "USE_PROMPT_VALIDITY_FILTER=${USE_PROMPT_VALIDITY_FILTER}"
echo "USE_SAM_SELECTOR=${USE_SAM_SELECTOR}"
